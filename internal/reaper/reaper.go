...
// all production databases. Delegates to doltserver.DiscoverProductionDatabases
// for centralized filtering. Returns nil on failure — callers handle empty lists.
