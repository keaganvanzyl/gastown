...
// IsProductionDatabase returns true if the database name is a real production
// database — not a system database and not test pollution.
...
// pollution. Returns (nil, error) on failure — callers decide their own fallback.
