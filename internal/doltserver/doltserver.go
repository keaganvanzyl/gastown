...
// Databases with these prefixes should be excluded from production operations.
...
// This is the single source of truth for database filtering across all
// consumers (reaper, compactor, doctor, health, snapshots, shell plugins).
...
// pollution using IsProductionDatabase. Returns (nil, error) on failure —
// callers decide their own fallback strategy.
